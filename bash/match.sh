...
python ../weight_matching/model_matching.py
...
mv m2o.checkpoint.pth.tar ./r2o/checkpoint.pth.tar
mv m2.checkpoint.pth.tar ./r22/checkpoint.pth.tar
mv m1.checkpoint.pth.tar ./r12/checkpoint.pth.tar

# run interpolation code
echo "interpolate model"
python ../weight_matching/weight_matching.py
