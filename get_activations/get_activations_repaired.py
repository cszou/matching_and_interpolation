...
if __name__=='__main__':
    ...
    print(f'Finding top images for repaired model:')
    activations = {}
    activations_norms = {}
    model.to(device)
    model.eval()
    ...
    print(f'Top images for repaired model found!')
    ...
    torch.save({'top_norms': top_norms,
                'top_dataset_indices': top_dataset_indices}, 'repaired.result.pth.tar')
