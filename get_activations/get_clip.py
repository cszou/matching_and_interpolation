...
def get_clip_encodings_from_index_vector(indices, dataloader, model, clip_device):
    ...
    # top_images2 = get_images_from_indices2(indices, 1, dataloader).squeeze() #Need to squeeze for the model
    # print(f'top_images shape: {top_images.shape}')
    # print(top_images2.shape)
...
if __name__ == '__main__':
    ...
    # indices_m2 = torch.load('m2.result.pth.tar')['top_dataset_indices']
        embeddings_m1[k] = get_clip_encodings_from_index_tensor(v)
